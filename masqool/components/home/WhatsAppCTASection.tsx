...
export default function WhatsAppCTASection() {
  ...
  const waHref = `https://wa.me/${WHATSAPP_NUMBER.replace('+', '')}?text=${encodeURIComponent(t('wa.cta'))}`;

  return (
    <section
      className="relative py-24 md:py-32 overflow-hidden"
      style={{ backgroundImage: `url('/media/images/masqool-hero-05.jpeg')`, backgroundSize: 'cover', backgroundPosition: 'center' }}
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-5 md:px-10 text-center">
        ...
        >
          <span
            className="text-[#C4956A] text-xs tracking-[0.25em] uppercase mb-5 block"
            style={{ fontFamily: "'Cormorant Garamond', serif" }}
          >
            {WHATSAPP_DISPLAY}
          </span>
          <h2
            className="text-3xl sm:text-4xl md:text-5xl text-white mb-5 leading-tight"
